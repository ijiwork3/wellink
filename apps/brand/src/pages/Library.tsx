              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-3 rounded-xl bg-amber-50 border border-amber-100">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-amber-700">{downloadModal.scope === 'all' ? '전체 콘텐츠' : '선택 콘텐츠'} <span className="font-semibold">{count}건</span> · 현재 <span className="font-semibold">{planLabel}</span></p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-xl p-4 space-y-2">
                  ...
                  <div className="flex justify-between text-sm border-t border-gray-200 pt-2 mt-2">
                    ...
                    <span className="text-gray-900 font-medium">{count}건 (즉시 다운로드)</span>
                  </div>
                </div>
                <div className="space-y-2">
