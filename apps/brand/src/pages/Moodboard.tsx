...
const ACCENT = [
  { n: 1,
    badgeActiveBg:'var(--color-mb-accent-1-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-1-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-1-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-1-badge-pending-text)',
    barB:'var(--color-mb-accent-1-bar-b)', barC:'var(--color-mb-accent-1-bar-c)', trendDown:'var(--color-mb-accent-1-trend-down)',
    dotA:'var(--color-mb-accent-1-dot-a)', dotB:'var(--color-mb-accent-1-dot-b)', dotC:'var(--color-mb-accent-1-dot-c)',
    av1:'var(--color-mb-accent-1-av1)', av2:'var(--color-mb-accent-1-av2)', av3:'var(--color-mb-accent-1-av3)', av4:'var(--color-mb-accent-1-av4)', av5:'var(--color-mb-accent-1-av5)',
  },
  { n: 2,
    badgeActiveBg:'var(--color-mb-accent-2-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-2-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-2-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-2-badge-pending-text)',
    barB:'var(--color-mb-accent-2-bar-b)', barC:'var(--color-mb-accent-2-bar-c)', trendDown:'var(--color-mb-accent-2-trend-down)',
    dotA:'var(--color-mb-accent-2-dot-a)', dotB:'var(--color-mb-accent-2-dot-b)', dotC:'var(--color-mb-accent-2-dot-c)',
    av1:'var(--color-mb-accent-2-av1)', av2:'var(--color-mb-accent-2-av2)', av3:'var(--color-mb-accent-2-av3)', av4:'var(--color-mb-accent-2-av4)', av5:'var(--color-mb-accent-2-av5)',
  },
  { n: 3,
    badgeActiveBg:'var(--color-mb-accent-3-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-3-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-3-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-3-badge-pending-text)',
    barB:'var(--color-mb-accent-3-bar-b)', barC:'var(--color-mb-accent-3-bar-c)', trendDown:'var(--color-mb-accent-3-trend-down)',
    dotA:'var(--color-mb-accent-3-dot-a)', dotB:'var(--color-mb-accent-3-dot-b)', dotC:'var(--color-mb-accent-3-dot-c)',
    av1:'var(--color-mb-accent-3-av1)', av2:'var(--color-mb-accent-3-av2)', av3:'var(--color-mb-accent-3-av3)', av4:'var(--color-mb-accent-3-av4)', av5:'var(--color-mb-accent-3-av5)',
  },
  { n: 4,
    badgeActiveBg:'var(--color-mb-accent-4-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-4-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-4-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-4-badge-pending-text)',
    barB:'var(--color-mb-accent-4-bar-b)', barC:'var(--color-mb-accent-4-bar-c)', trendDown:'var(--color-mb-accent-4-trend-down)',
    dotA:'var(--color-mb-accent-4-dot-a)', dotB:'var(--color-mb-accent-4-dot-b)', dotC:'var(--color-mb-accent-4-dot-c)',
    av1:'var(--color-mb-accent-4-av1)', av2:'var(--color-mb-accent-4-av2)', av3:'var(--color-mb-accent-4-av3)', av4:'var(--color-mb-accent-4-av4)', av5:'var(--color-mb-accent-4-av5)',
  },
  { n: 5,
    badgeActiveBg:'var(--color-mb-accent-5-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-5-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-5-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-5-badge-pending-text)',
    barB:'var(--color-mb-accent-5-bar-b)', barC:'var(--color-mb-accent-5-bar-c)', trendDown:'var(--color-mb-accent-5-trend-down)',
    dotA:'var(--color-mb-accent-5-dot-a)', dotB:'var(--color-mb-accent-5-dot-b)', dotC:'var(--color-mb-accent-5-dot-c)',
    av1:'var(--color-mb-accent-5-av1)', av2:'var(--color-mb-accent-5-av2)', av3:'var(--color-mb-accent-5-av3)', av4:'var(--color-mb-accent-5-av4)', av5:'var(--color-mb-accent-5-av5)',
  },
  { n: 6,
    badgeActiveBg:'var(--color-mb-accent-6-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-6-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-6-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-6-badge-pending-text)',
    barB:'var(--color-mb-accent-6-bar-b)', barC:'var(--color-mb-accent-6-bar-c)', trendDown:'var(--color-mb-accent-6-trend-down)',
    dotA:'var(--color-mb-accent-6-dot-a)', dotB:'var(--color-mb-accent-6-dot-b)', dotC:'var(--color-mb-accent-6-dot-c)',
    av1:'var(--color-mb-accent-6-av1)', av2:'var(--color-mb-accent-6-av2)', av3:'var(--color-mb-accent-6-av3)', av4:'var(--color-mb-accent-6-av4)', av5:'var(--color-mb-accent-6-av5)',
  },
  { n: 7,
    badgeActiveBg:'var(--color-mb-accent-7-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-7-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-7-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-7-badge-pending-text)',
    barB:'var(--color-mb-accent-7-bar-b)', barC:'var(--color-mb-accent-7-bar-c)', trendDown:'var(--color-mb-accent-7-trend-down)',
    dotA:'var(--color-mb-accent-7-dot-a)', dotB:'var(--color-mb-accent-7-dot-b)', dotC:'var(--color-mb-accent-7-dot-c)',
    av1:'var(--color-mb-accent-7-av1)', av2:'var(--color-mb-accent-7-av2)', av3:'var(--color-mb-accent-7-av3)', av4:'var(--color-mb-accent-7-av4)', av5:'var(--color-mb-accent-7-av5)',
  },
  { n: 8,
    badgeActiveBg:'var(--color-mb-accent-8-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-8-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-8-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-8-badge-pending-text)',
    barB:'var(--color-mb-accent-8-bar-b)', barC:'var(--color-mb-accent-8-bar-c)', trendDown:'var(--color-mb-accent-8-trend-down)',
    dotA:'var(--color-mb-accent-8-dot-a)', dotB:'var(--color-mb-accent-8-dot-b)', dotC:'var(--color-mb-accent-8-dot-c)',
    av1:'var(--color-mb-accent-8-av1)', av2:'var(--color-mb-accent-8-av2)', av3:'var(--color-mb-accent-8-av3)', av4:'var(--color-mb-accent-8-av4)', av5:'var(--color-mb-accent-8-av5)',
  },
  { n: 9,
    badgeActiveBg:'var(--color-mb-accent-9-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-9-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-9-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-9-badge-pending-text)',
    barB:'var(--color-mb-accent-9-bar-b)', barC:'var(--color-mb-accent-9-bar-c)', trendDown:'var(--color-mb-accent-9-trend-down)',
    dotA:'var(--color-mb-accent-9-dot-a)', dotB:'var(--color-mb-accent-9-dot-b)', dotC:'var(--color-mb-accent-9-dot-c)',
    av1:'var(--color-mb-accent-9-av1)', av2:'var(--color-mb-accent-9-av2)', av3:'var(--color-mb-accent-9-av3)', av4:'var(--color-mb-accent-9-av4)', av5:'var(--color-mb-accent-9-av5)',
  },
  { n: 10,
    badgeActiveBg:'var(--color-mb-accent-10-badge-active-bg)',    badgeActiveText:'var(--color-mb-accent-10-badge-active-text)',
    badgePendingBg:'var(--color-mb-accent-10-badge-pending-bg)',  badgePendingText:'var(--color-mb-accent-10-badge-pending-text)',
    barB:'var(--color-mb-accent-10-bar-b)', barC:'var(--color-mb-accent-10-bar-c)', trendDown:'var(--color-mb-accent-10-trend-down)',
    dotA:'var(--color-mb-accent-10-dot-a)', dotB:'var(--color-mb-accent-10-dot-b)', dotC:'var(--color-mb-accent-10-dot-c)',
    av1:'var(--color-mb-accent-10-av1)', av2:'var(--color-mb-accent-10-av2)', av3:'var(--color-mb-accent-10-av3)', av4:'var(--color-mb-accent-10-av4)', av5:'var(--color-mb-accent-10-av5)',
  },
]
...
function Badge({ bg, text, children }: { bg: string; text: string; children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center gap-1 text-[15px] font-medium px-2.5 py-1 rounded-full"
  ...
  return (
    <div className="w-[220px] shrink-0 flex flex-col h-full border-r" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
      <div className="px-5 pt-5 pb-4 flex items-center gap-1.5">
        ...
        <span className="text-[15px] font-medium px-2 py-1 rounded-full leading-none text-white" style={{ backgroundColor: p.green }}>광고주</span>
      </div>
      <nav className="flex-1 px-3 overflow-y-auto">
        {navItems.map(item => {
          ...
          return (
            <div key={item.key}>
              {showSection && (
                <div className="text-[15px] font-semibold uppercase tracking-widest px-3 mt-4 mb-1" style={{ color: g.subtle }}>{item.section}</div>
              )}
              <div className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[15px] mb-0.5 cursor-pointer"
                style={isActive
      ...
      <div className="px-3 pb-5 pt-3 border-t" style={{ borderColor: g.border }}>
        <div className="flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer">
          <div className="w-7 h-7 rounded-full flex items-center justify-center text-[15px] font-bold shrink-0" style={{ backgroundColor: g.pillBg, color: g.muted }}>W</div>
          <div className="flex-1 min-w-0">
            <p className="text-[15px] font-medium text-gray-900 break-words">웰링크 브랜드</p>
            <p className="text-[15px] break-words" style={{ color: g.subtle }}>brand@wellink.ai</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <div className="px-6 py-4 flex items-center justify-between border-b" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
          <div>
            ...
            <p className="text-[15px] mt-0.5" style={{ color: g.muted }}>2026년 4월 25일 금요일</p>
          </div>
          <button type="button" className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-[15px] font-medium text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/50" style={{ backgroundColor: p.green }}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            {kpis.map((k, i) => (
              <div key={i} className="border shadow-sm rounded-xl p-5 flex flex-col gap-3" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
                <div className="flex items-center justify-between">
                  <span className="text-[15px] font-medium" style={{ color: g.muted }}>{k.label}</span>
                  <span style={{ color: g.subtle }}>{k.icon}</span>
                </div>
                <div className="text-[28px] font-bold text-gray-900 leading-tight">{k.value}</div>
                <div className="flex items-center gap-1 text-[15px] font-medium" style={{ color: k.up ? d.color : a.trendDown }}>
          ...
          <div className="grid grid-cols-1 @lg:grid-cols-3 gap-4">
            <div className="@lg:col-span-2 border shadow-sm rounded-xl overflow-hidden" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
              <div className="flex items-center justify-between px-5 py-4 border-b" style={{ borderColor: g.border }}>
                <h2 className="text-[15px] font-semibold text-gray-900">활성 캠페인 현황</h2>
                <button type="button" className="text-[15px] flex items-center gap-1 px-2 py-1 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/50" style={{ color: d.color }}>전체보기 <ArrowRight size={12} aria-hidden="true" /></button>
              </div>
              <table className="w-full text-[15px]">
                <thead>
                  <tr className="border-b" style={{ backgroundColor: g.pillBg, borderColor: g.border }}>
                    {['캠페인명','상태','진행률','마감일',''].map(h => (
                      <th key={h} className="text-left text-[15px] font-medium py-2.5 px-4 whitespace-nowrap" style={{ color: g.muted }}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={i} className="border-b last:border-0" style={{ borderColor: g.border }}>
                      <td className="py-3.5 px-4 text-[15px] font-medium text-gray-900">{c.name}</td>
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[15px]" style={{ color: g.muted }}>{c.pct}%</span>
                        </div>
                      </td>
                      <td className="py-3.5 px-4 text-[15px]" style={{ color: g.muted }}>{c.dday}</td>
                      <td className="py-3.5 px-4">
                        <button type="button" className="text-[15px] flex items-center gap-1 px-2 py-1 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/50" style={{ color: d.color }}>상세 <ArrowRight size={12} aria-hidden="true" /></button>
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="border shadow-sm rounded-xl overflow-hidden flex flex-col" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
              <div className="flex items-center gap-2 px-5 py-4 border-b" style={{ borderColor: g.border }}>
                ...
                <h2 className="text-[15px] font-semibold text-gray-900">최근 알림</h2>
                <span className="text-[15px] font-bold px-2 py-1 rounded-full leading-none text-white" style={{ backgroundColor: p.green }}>3</span>
              </div>
              {notifications.map((n, i) => (
                <div key={i} className="px-5 py-3 border-b last:border-0" style={{ borderColor: g.border }}>
                  <div className="flex gap-2.5 items-start">
                    ...
                    <div>
                      <p className="text-[15px] leading-relaxed" style={{ color: n.unread ? SEMANTIC_COLORS.textPrimary : g.muted, fontWeight: n.unread ? 500 : 400 }}>{n.text}</p>
                      <p className="text-[15px] mt-0.5" style={{ color: g.subtle }}>{n.time}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          {/* 빠른 실행 */}
          <div>
            <h2 className="text-[15px] font-semibold text-gray-900 mb-3">빠른 실행</h2>
            <div className="grid grid-cols-2 @lg:grid-cols-4 gap-3">
              {[
                ...
                <div key={i} className="border shadow-sm rounded-xl p-4 cursor-pointer" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
                  ...
                  <p className="text-[15px] mt-0.5" style={{ color: g.subtle }}>{item.sub}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <div className="px-6 py-4 flex items-center justify-between border-b" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
          <div>
            ...
            <p className="text-[15px] mt-0.5" style={{ color: g.muted }}>브랜드에 적합한 인플루언서를 탐색하세요.</p>
          </div>
          <button type="button" className="px-4 py-2.5 rounded-xl text-[15px] font-medium text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/50" style={{ backgroundColor: p.green }}>+ 캠페인 제안</button>
        </div>
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
          <div className="grid grid-cols-2 @lg:grid-cols-4 gap-3">
            {summary.map((stat, i) => (
              <div key={i} className="border shadow-sm rounded-xl px-4 py-3" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
                <p className="text-[15px]" style={{ color: g.subtle }}>{stat.label}</p>
                <p className="text-xl font-bold text-gray-900 mt-0.5">{stat.value}</p>
              </div>
            ))}
          </div>
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2 flex-1 px-3 py-2 rounded-xl text-[15px] border shadow-sm" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
              <Search size={14} style={{ color: g.subtle }} className="shrink-0"/>
              <span className="text-[15px]" style={{ color: g.subtle }}>이름으로 검색...</span>
            </div>
            {['카테고리','핏 스코어','참여율','팔로워급'].map(f => (
              <div key={f} className="px-3 py-2 rounded-xl text-[15px] font-medium cursor-pointer border shrink-0"
              ...
              <thead>
                <tr className="border-b" style={{ backgroundColor: g.pillBg, borderColor: g.border }}>
                  {['인플루언서','카테고리','팔로워','참여율','Fit Score','진성비율','최근 콘텐츠',''].map(h => (
                    <th key={h} className="text-left text-[15px] font-medium py-3 px-4 whitespace-nowrap" style={{ color: g.muted }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={i} className="border-b last:border-0" style={{ borderColor: g.border }}>
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-full flex items-center justify-center text-white font-semibold text-[15px] shrink-0" style={{ backgroundColor: r.avColor }}>
                          {r.name[0]}
                        </div>
                        <span className="text-[15px] font-medium text-gray-900">{r.name}</span>
                        <Heart size={14}
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-1 flex-wrap">
                        {r.cats.map(c => (
                          <span key={c} className="text-[15px] px-2.5 py-1 rounded-full" style={{ backgroundColor: g.pillBg, color: g.muted }}>{c}</span>
                        ))}
                      </div>
                    </td>
                    <td className="py-3 px-4 text-[15px]" style={{ color: g.muted }}>{r.followers}</td>
                    <td className="py-3 px-4 text-[15px] font-semibold" style={{ color: r.engHigh ? d.color : g.muted }}>{r.eng}</td>
                    <td className="py-3 px-4">
                      <Badge bg={r.fitHigh ? a.badgeActiveBg : a.badgePendingBg} text={r.fitHigh ? a.badgeActiveText : a.badgePendingText}>{r.fit}</Badge>
                    </td>
                    <td className="py-3 px-4 text-[15px] font-medium" style={{ color: d.color }}>{r.authentic}</td>
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4">
                      <button type="button" className="text-[15px] px-3 py-2.5 rounded-lg font-medium text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/50" style={{ backgroundColor: p.green }}>제안</button>
                    </td>
                  </tr>
                ))}
              </tbody>
  ...
  return (
    <div className="flex h-full" style={{ backgroundColor: g.pageBg }}>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <div className="px-6 py-4 flex items-center justify-between border-b" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
          <div>
            <p className="text-[15px]" style={{ color: g.subtle }}>리포트</p>
          ...
          <div className="flex items-center gap-2">
            <div className="flex gap-1 p-1 rounded-xl" style={{ backgroundColor: g.pillBg }}>
              {['최근 7일','최근 30일','이번 달'].map((label, i) => (
                <span key={label} className="text-[15px] px-3 py-1.5 rounded-lg cursor-pointer font-medium"
                  style={i === 1 ? { backgroundColor: g.cardBg, color: SEMANTIC_COLORS.textPrimary, boxShadow: '0 1px 2px rgba(0,0,0,0.05)' } : { color: g.subtle }}>
                  {label}
                </span>
              ))}
            </div>
            <button type="button" className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-[15px] font-medium border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/50" style={{ backgroundColor: g.cardBg, borderColor: g.border, color: g.muted }}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            {metrics.map((m, i) => (
              <div key={i} className="border shadow-sm rounded-xl p-5" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
                <div className="flex items-center justify-between mb-3">
                  <span className="text-[15px] font-medium" style={{ color: g.muted }}>{m.label}</span>
                  <span style={{ color: g.subtle }}>{m.icon}</span>
                </div>
                <p className="text-3xl font-bold text-gray-900 mb-2">{m.value}</p>
                <span className="text-[15px] font-medium inline-flex items-center gap-1" style={{ color: m.up ? d.color : a.trendDown }}>
          ...
          <div className="border shadow-sm rounded-xl p-6" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-[15px] font-semibold text-gray-900">주간 도달 & 참여 추이</h2>
              <div className="flex items-center gap-5 text-[15px]" style={{ color: g.subtle }}>
            ...
            <div className="flex items-end gap-2" style={{ height: 120 }}>
              {chartData.map((d2, i) => (
                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                  ...
                  <span className="text-[15px] whitespace-nowrap" style={{ color: g.subtle }}>{d2.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="border shadow-sm rounded-xl overflow-hidden" style={{ backgroundColor: g.cardBg, borderColor: g.border }}>
            <div className="px-5 py-4 flex items-center justify-between border-b" style={{ borderColor: g.border }}>
              <h2 className="text-[15px] font-semibold text-gray-900">캠페인별 성과 비교</h2>
              <button type="button" className="text-[15px] px-3 py-2.5 rounded-lg border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/50" style={{ backgroundColor: g.cardBg, borderColor: g.border, color: g.muted }}>전체 보기</button>
            </div>
            <table className="w-full text-[15px]">
              <thead>
                <tr className="border-b" style={{ backgroundColor: g.pillBg, borderColor: g.border }}>
                  {['캠페인','총 도달','평균 참여율','콘텐츠 수','ROAS','상태'].map(h => (
                    <th key={h} className="px-5 py-3 text-left text-[15px] font-medium whitespace-nowrap" style={{ color: g.muted }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {campaigns.map((c, i) => (
                  <tr key={i} className="border-b last:border-0" style={{ borderColor: g.border }}>
                    ...
                    <td className="px-5 py-4">
                      {c.active === null
                        ? <span className="inline-flex items-center text-[15px] font-medium px-2.5 py-1 rounded-full" style={{ backgroundColor: g.pillBg, color: g.muted }}>완료</span>
    ...
    <div className="h-screen overflow-y-auto bg-zinc-800">
      <div className="sticky top-0 z-50 bg-white border-b border-gray-200 px-8 py-3 flex items-center gap-5">
        ...
        <div className="flex items-center gap-3">
          <span className="text-[15px] font-semibold text-gray-700 shrink-0">프라이머리</span>
          ...
          <span className="text-[15px] font-bold text-gray-900 w-4 shrink-0">{pi + 1}</span>
          <div className="w-4 h-4 rounded-full border border-gray-200" style={{ backgroundColor: p.green }}/>
        </div>
        <div className="w-px h-5 bg-gray-200 shrink-0"/>
        {/* 딥 */}
        <div className="flex items-center gap-3">
          <span className="text-[15px] font-semibold text-gray-700 shrink-0">프라이머리 딥</span>
          ...
          <span className="text-[15px] font-bold text-gray-900 w-4 shrink-0">{di + 1}</span>
          <div className="w-4 h-4 rounded-full border border-gray-200" style={{ backgroundColor: d.color }}/>
        </div>
        <div className="w-px h-5 bg-gray-200 shrink-0"/>
        {/* 나머지 */}
        <div className="flex items-center gap-3">
          <span className="text-[15px] font-semibold text-gray-700 shrink-0">나머지</span>
          ...
          <span className="text-[15px] font-bold text-gray-900 w-4 shrink-0">{ai + 1}</span>
        ...
        {/* 그레이톤 */}
        <div className="flex items-center gap-3">
          <span className="text-[15px] font-semibold text-gray-700 shrink-0">그레이톤</span>
          ...
          <span className="text-[15px] font-bold text-gray-900 w-4 shrink-0">{gi + 1}</span>
          <div className="flex items-center gap-1">
