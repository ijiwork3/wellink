...
export default function ProfileInsight() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 콘텐츠 유형별 성과 + 팔로워 추이 */}
      <div className="grid grid-cols-1 @[960px]:grid-cols-5 gap-3 @sm:gap-5">
        {/* 콘텐츠 유형별 성과 (3/5) */}
        <div className="@[960px]:col-span-3 bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        ...
        {/* 팔로워 추이 (2/5) */}
        <div className="@[960px]:col-span-2 bg-white rounded-xl border border-gray-100 shadow-sm p-5">
          <div className="mb-4">
