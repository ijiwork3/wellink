          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="mb-8 flex items-center gap-4 rounded-2xl bg-white p-6 shadow-sm">
              ...
              <div>
                ...
                <div className="text-[15px] text-slate-500">매칭 대기 중인 인플루언서</div>
              </div>
            </div>

            <div className="inline-block rounded-xl bg-[var(--color-landing-dark)] px-6 py-4 text-white">
              <div className="text-[15px] font-bold uppercase tracking-wider opacity-60">
                Conversion Rate
              </div>
            ...
            <div className="relative h-[420px] w-[240px] sm:h-[520px] sm:w-[270px] lg:h-[600px] lg:w-[300px] overflow-hidden rounded-[2.5rem] lg:rounded-[3rem] border-8 border-slate-900 bg-white shadow-2xl">
              ...
              <div className="p-4">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[15px] font-bold">@WELLINK_STAR</div>
                    <div className="text-[15px] text-slate-400">Seoul, Korea</div>
                  </div>
                </div>
