      ...
      <main id="main-content">
        ...
        <section className="bg-[#111827] py-24 text-white md:py-32">
          <div className="mx-auto max-w-7xl px-6">
            <div className="grid items-center gap-16 lg:grid-cols-2">
              <div>
                <span className="mb-4 inline-block rounded-full bg-lime-400/10 px-3 py-1 text-xs font-bold tracking-wider text-[#BFF264] uppercase">
                  04. Operation Automation
                </span>
                <h2 className="mb-6 text-3xl font-black leading-tight md:text-5xl">
                  모집부터 보고서까지
                  <br />
                  <span className="text-[#BFF264]">단 10분.</span>
                  <br />
                  수동 업무에서 해방되세요.
                </h2>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={item} className="flex items-center gap-3 font-bold">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#BFF264] text-[#0A3622]">
                    ...
                    {[0.8, 0.6, 0.9].map((w, i) => (
                      <div key={i} className="flex items-center gap-4">
                        ...
                        <div className="h-2 flex-1 rounded-full bg-white/10">
                          {shouldReduceMotion ? (
                            <div
                              className="h-full rounded-full bg-[#BFF264]"
                              style={{ width: `${w * 100}%` }}
                            />
                          ) : (
                            <motion.div
          ...
          <div className="mx-auto max-w-7xl px-6 text-center">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                >
                  <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-50 text-[#0A3622]">
                    <item.icon size={28} />
                  </div>
              ...
              {[
                ...
                >
                  <div className={cn('flex w-1/3 flex-col items-center justify-center p-8', item.color)}>
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-white font-black text-[#0A3622] shadow-sm">
                      {item.id}
                    </div>
        ...
        <section className="relative overflow-hidden bg-[#0A3622] py-24 text-white md:py-32">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
            <span className="mb-4 block text-sm font-bold tracking-wider text-[#BFF264] uppercase">
              Standard Operating Procedure
            </span>
            <h2 className="mb-16 text-3xl font-black leading-tight md:text-5xl">
              피트니스 마케팅의
              <br />
              <span className="text-[#BFF264]">체계적인 성과 창출 프로세스</span>
            </h2>
              ...
              {[
                ...
                <div key={item.step} className="group relative">
                  <div className="mb-8 flex justify-center">
                    <div className="flex h-24 w-24 items-center justify-center rounded-full bg-[#BFF264] text-3xl font-black text-[#0A3622] transition-transform group-hover:scale-110">
                      {item.step}
                    </div>
                  </div>
