  ...
  return (
    <div className="flex items-center gap-1 text-[11px]">
      ...
      <select
        ...
        className="bg-slate-800 text-white border border-slate-600 rounded-md px-1.5 py-1 text-[11px] hover:border-slate-400 focus:outline-none focus:border-white transition-colors"
