  ...
  return (
    <div className="relative flex h-full bg-gray-50 overflow-hidden">
          ...
          >
            <div className="flex items-center justify-between px-4 py-3 shrink-0">
              ...
              <button
                ...
                aria-label="홈으로 이동"
              >
                WELLINK<span className="text-brand-green">.AI</span> <span style={{ background: 'var(--gradient-brand)' }} className="text-[15px] font-medium text-white px-2 py-1 rounded-full ml-1">광고주</span>
              </button>
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden min-w-0 flex flex-col relative">
        ...
        <main id="main-content" className={`@container w-full max-w-[1700px] mx-auto ${device === 'phone' ? 'px-4 py-4' : device === 'tablet' ? 'px-6 py-5' : 'px-8 py-7'}`}>
          <Outlet />
        </main>
      </div>
    </div>
