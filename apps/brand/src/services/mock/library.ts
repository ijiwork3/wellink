...
export type LibraryPlatform = '인스타그램' | '유튜브' | '블로그'
...
export const mockLibraryContents: LibraryContent[] = [
  ...
  { id: 7, creator: '오진석', campaign: '여름 캠페인', platform: '블로그', date: '2026-04-07', reach: 3400, likes: 210, comments: 34, saves: 45, shareRate: 2.1, engagementRate: 8.5, status: '검수중', thumbnailClass: 'bg-orange-300' },
