...
- 타 브랜드 비교 비방성 표현 금지`,
  ...
  },
  {
    ...
    headcount: 8,
    applied: 4,
    conditions: ['블로그 이웃 500명 이상', '포스팅 1개 이상', '사진 5장 이상'],
    type: 'delivery',
  },
  {
    id: 6,
  ...
  { id: 12, brand: '에스트라', name: '아토베리어 크림 체험단', channel: '블로그', category: '뷰티·패션', status: '모집중', applyStart: '2026-07-22', applyEnd: '2026-08-01', announceDate: '2026-08-05', postStart: '2026-07-08', postEnd: '2026-07-08', image: '🌿', description: '민감성 피부를 위한 에스트라 아토베리어 크림을 블로그에 상세 리뷰해 주세요', reward: '아토베리어 세트 (15만원 상당)', rewardAmount: 150000, headcount: 8, applied: 3, type: 'delivery', postType: '블로그 포스팅' },
  ...
  { id: 22, brand: '구달', name: '비타C 트리플C 세럼 체험단', channel: '블로그', category: '뷰티·패션', status: '모집중', applyStart: '2026-07-24', applyEnd: '2026-08-03', announceDate: '2026-08-07', postStart: '2026-08-10', postEnd: '2026-09-10', image: '🍊', description: '구달 비타C 세럼으로 화사한 피부 만들기 4주 체험기를 블로그에 작성해 주세요', reward: '비타C 세럼 세트 (9만원 상당)', rewardAmount: 90000, headcount: 10, applied: 4, type: 'delivery' },
  ...
  { id: 57, brand: '정관장', name: '홍삼 에브리타임 체험단', channel: '블로그', category: '맛집·푸드', status: '모집중', applyStart: '2026-07-22', applyEnd: '2026-08-01', announceDate: '2026-08-05', postStart: '2026-07-08', postEnd: '2026-07-08', image: '🌿', description: '정관장 홍삼 에브리타임을 한 달간 꾸준히 복용하고 활력 변화를 블로그에 기록해 주세요', reward: '홍삼 에브리타임 1개월분 (15만원 상당)', rewardAmount: 150000, headcount: 8, applied: 3, type: 'delivery' },
  ...
  { id: 68, brand: '더반찬', name: '프리미엄 반찬 구독 체험단', channel: '블로그', category: '맛집·푸드', status: '종료', applyStart: '2026-07-06', applyEnd: '2026-07-19', announceDate: '2026-07-23', postStart: '2026-07-26', postEnd: '2026-08-16', image: '🥘', description: '더반찬 프리미엄 반찬 구독 서비스를 2주 체험하고 블로그에 상세 후기를 작성해 주세요', reward: '반찬 구독 2주 무료 (15만원 상당)', rewardAmount: 150000, headcount: 10, applied: 10, type: 'delivery' },

  // 라이프스타일 ──────────────────────────────────────────────────────────────
  { id: 69, brand: '에이스침대', name: '숙면 매트리스 체험단', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-20', applyEnd: '2026-07-30', announceDate: '2026-08-03', postStart: '2026-07-06', postEnd: '2026-07-06', image: '🛏️', description: '에이스침대 숙면 매트리스를 한 달간 사용하고 수면 질 변화를 콘텐츠로 기록해 주세요', reward: '매트리스 1개월 체험 (대여)', rewardAmount: 500000, headcount: 5, applied: 4, type: 'delivery', priorityType: '홈 인테리어·라이프스타일 계정 우대' },
  { id: 70, brand: '다이슨', name: '에어랩 헤어 스타일링 체험', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-23', applyEnd: '2026-08-02', announceDate: '2026-08-06', postStart: '2026-07-09', postEnd: '2026-07-09', image: '💇', description: '다이슨 에어랩으로 다양한 헤어스타일을 연출하고 비포·애프터 콘텐츠를 제작해 주세요', reward: '에어랩 체험 (대여 1개월)', rewardAmount: 700000, headcount: 3, applied: 2, type: 'delivery' },
  { id: 71, brand: '필립스', name: '에어프라이어 레시피 챌린지', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-25', applyEnd: '2026-08-04', announceDate: '2026-08-08', postStart: '2026-08-11', postEnd: '2026-09-11', image: '🍳', description: '필립스 에어프라이어로 건강한 요리 레시피를 개발하고 콘텐츠를 제작해 주세요', reward: '에어프라이어 제공 (20만원 상당)', rewardAmount: 200000, headcount: 5, applied: 3, type: 'delivery', postType: '릴스 레시피' },
  { id: 72, brand: '이케아', name: '홈 오피스 인테리어 체험단', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-22', applyEnd: '2026-08-01', announceDate: '2026-08-05', postStart: '2026-07-08', postEnd: '2026-07-08', image: '🪑', description: '이케아 홈 오피스 가구로 나만의 작업 공간을 꾸미고 인테리어 콘텐츠를 제작해 주세요', reward: '이케아 상품권 15만원', rewardAmount: 150000, headcount: 8, applied: 4, type: 'delivery' },
  { id: 73, brand: '제주항공', name: '제주 여행 브이로그 제작', channel: '유튜브', category: '생활·리빙', status: '마감임박', applyStart: '2026-07-19', applyEnd: '2026-07-25', announceDate: '2026-07-29', postStart: '2026-07-01', postEnd: '2026-08-30', image: '✈️', description: '제주항공으로 제주도 여행을 다녀오고 여행 브이로그를 유튜브에 업로드해 주세요', reward: '왕복 항공권 + 숙박 3박 (80만원 상당)', rewardAmount: 800000, headcount: 2, applied: 2, type: 'visit', region: '제주도', conditions: ['구독자 5,000명 이상', '여행·라이프 유튜브 채널 보유'] },
  { id: 74, brand: '캐논', name: '미러리스 카메라 체험단', channel: '유튜브', category: '생활·리빙', status: '모집중', applyStart: '2026-07-26', applyEnd: '2026-08-05', announceDate: '2026-08-09', postStart: '2026-08-12', postEnd: '2026-09-12', image: '📷', description: '캐논 EOS R10 미러리스 카메라를 한 달간 체험하고 포토·영상 리뷰를 제작해 주세요', reward: 'EOS R10 1개월 체험 (대여, 100만원 상당)', rewardAmount: 1000000, headcount: 3, applied: 2, type: 'delivery' },
  { id: 75, brand: '삼성전자', name: '갤럭시 S25 일상 체험기', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-24', applyEnd: '2026-08-03', announceDate: '2026-08-07', postStart: '2026-08-10', postEnd: '2026-09-10', image: '📱', description: '갤럭시 S25로 일상을 기록하고 카메라 성능·AI 기능 활용 콘텐츠를 제작해 주세요', reward: 'S25 1개월 체험 (대여)', rewardAmount: 1200000, headcount: 5, applied: 3, type: 'delivery' },
  { id: 76, brand: '에이블리', name: '봄·여름 패션 코디 챌린지', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-27', applyEnd: '2026-08-06', announceDate: '2026-08-10', postStart: '2026-08-13', postEnd: '2026-09-03', image: '👗', description: '에이블리 봄여름 신상 코디를 구성하고 데일리룩 콘텐츠를 3회 이상 올려주세요', reward: '에이블리 쇼핑 크레딧 10만원', rewardAmount: 100000, headcount: 20, applied: 9, type: 'delivery' },
  { id: 77, brand: '무신사', name: '스트리트 패션 스타일링 챌린지', channel: '인스타그램', category: '생활·리빙', status: '마감임박', applyStart: '2026-07-20', applyEnd: '2026-07-25', announceDate: '2026-07-29', postStart: '2026-07-01', postEnd: '2026-08-21', image: '🧥', description: '무신사 스트리트 패션 아이템으로 스타일링을 완성하고 룩북 콘텐츠를 제작해 주세요', reward: '무신사 스토어 상품권 12만원', rewardAmount: 120000, headcount: 15, applied: 14, type: 'delivery' },
  { id: 78, brand: '오늘의집', name: '홈 인테리어 리모델링 체험', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-29', applyEnd: '2026-08-08', announceDate: '2026-08-12', postStart: '2026-08-15', postEnd: '2026-09-15', image: '🏠', description: '오늘의집 인테리어 소품으로 방 하나를 새롭게 꾸미고 변화 전후 콘텐츠를 올려주세요', reward: '인테리어 소품 구매 지원금 15만원', rewardAmount: 150000, headcount: 10, applied: 4, type: 'delivery' },
  { id: 79, brand: '카카오', name: '카카오페이 리워드 생활금융 체험', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-21', applyEnd: '2026-07-31', announceDate: '2026-08-04', postStart: '2026-07-07', postEnd: '2026-08-27', image: '💛', description: '카카오페이 리워드 서비스를 일상에서 사용하고 혜택·편리함을 콘텐츠로 공유해 주세요', reward: '카카오페이 포인트 5만원 + 활동비 3만원', rewardAmount: 30000, headcount: 30, applied: 16, type: 'delivery' },
  { id: 80, brand: '배달의민족', name: '배민오더 카페 체험단', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-28', applyEnd: '2026-08-07', announceDate: '2026-08-11', postStart: '2026-08-14', postEnd: '2026-09-04', image: '☕', description: '배민오더 제휴 카페를 방문하고 매장 분위기·음료 콘텐츠를 제작해 주세요', reward: '음료 쿠폰 4만원 + 활동비 3만원', rewardAmount: 30000, headcount: 25, applied: 12, type: 'visit', storeName: '배민오더 성수 제휴 카페', region: '서울 성동구' },
  { id: 81, brand: '파타고니아', name: '지속가능 패션 캠페인', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-25', applyEnd: '2026-08-04', announceDate: '2026-08-08', postStart: '2026-08-11', postEnd: '2026-09-11', image: '♻️', description: '파타고니아 리사이클 제품을 착용하고 지속가능한 라이프스타일 콘텐츠를 제작해 주세요', reward: '파타고니아 아이템 (20만원 상당)', rewardAmount: 200000, headcount: 5, applied: 3, type: 'delivery', conditions: ['환경·지속가능성 관심 계정', '팔로워 3,000명 이상'] },
  { id: 82, brand: '아디다스', name: '라이프스타일 스니커즈 착용 챌린지', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-26', applyEnd: '2026-08-05', announceDate: '2026-08-09', postStart: '2026-08-12', postEnd: '2026-09-02', image: '👟', description: '아디다스 오리지널스 스니커즈로 일상 코디를 완성하고 스트리트 패션 콘텐츠를 제작해 주세요', reward: '스니커즈 1켤레 (15만원 상당)', rewardAmount: 150000, headcount: 8, applied: 4, type: 'delivery' },
  { id: 83, brand: '쏘카', name: '카셰어링 주말 여행 콘텐츠', channel: '유튜브', category: '생활·리빙', status: '마감임박', applyStart: '2026-07-19', applyEnd: '2026-07-25', announceDate: '2026-07-29', postStart: '2026-07-01', postEnd: '2026-08-21', image: '🚗', description: '쏘카 카셰어링으로 주말 드라이브 또는 근교 여행을 다녀오고 브이로그를 제작해 주세요', reward: '쏘카 크레딧 10만원 + 활동비 5만원', rewardAmount: 50000, headcount: 5, applied: 5, type: 'delivery' },
  { id: 84, brand: '교보문고', name: '독서 라이프 콘텐츠 챌린지', channel: '인스타그램', category: '생활·리빙', status: '모집중', applyStart: '2026-07-27', applyEnd: '2026-08-06', announceDate: '2026-08-10', postStart: '2026-08-13', postEnd: '2026-09-13', image: '📚', description: '교보문고에서 선정한 추천 도서를 읽고 북스타그램 및 독서 브이로그를 제작해 주세요', reward: '도서 3권 (6만원 상당) + 교보 포인트 3만원', rewardAmount: 30000, headcount: 15, applied: 6, type: 'delivery' },
  { id: 85, brand: '넷플릭스', name: '홈 시네마 환경 꾸미기 체험', channel: '인스타그램', category: '생활·리빙', status: '종료', applyStart: '2026-07-07', applyEnd: '2026-07-19', announceDate: '2026-07-23', postStart: '2026-07-26', postEnd: '2026-08-16', image: '🎬', description: '넷플릭스 오리지널 신작을 홈 시네마 환경에서 감상하고 인테리어 + 감상 콘텐츠를 올려주세요', reward: '넷플릭스 3개월 무료권 + 활동비 3만원', rewardAmount: 30000, headcount: 20, applied: 20, type: 'delivery' },

  // 육아·펫 ──────────────────────────────────────────────────────────────────
  { id: 86, brand: '맘앤베이비', name: '유기농 이유식 체험단', channel: '인스타그램', category: '기타', status: '모집중', applyStart: '2026-07-21', applyEnd: '2026-07-31', announceDate: '2026-08-04', postStart: '2026-07-07', postEnd: '2026-07-07', image: '🍼', description: '맘앤베이비 유기농 이유식으로 아이의 첫 이유식을 시작하고 체험 후기를 공유해 주세요', reward: '이유식 1개월 세트 (12만원 상당)', rewardAmount: 120000, headcount: 15, applied: 6, type: 'delivery', conditions: ['육아·맘 계정', '6~12개월 아이 보유'] },
  { id: 87, brand: '하기스', name: '기저귀 30일 사용 리뷰', channel: '인스타그램', category: '기타', status: '모집중', applyStart: '2026-07-24', applyEnd: '2026-08-03', announceDate: '2026-08-07', postStart: '2026-08-10', postEnd: '2026-09-10', image: '👶', description: '하기스 신제품 기저귀를 30일 동안 실사용하고 흡수력·피부 자극도 솔직 리뷰를 남겨주세요', reward: '기저귀 1개월분 (8만원 상당)', rewardAmount: 80000, headcount: 20, applied: 8, type: 'delivery' },
  { id: 88, brand: '앱솔루트', name: '분유 한 달 체험단', channel: '블로그', category: '기타', status: '모집중', applyStart: '2026-07-26', applyEnd: '2026-08-05', announceDate: '2026-08-09', postStart: '2026-08-12', postEnd: '2026-09-12', image: '🥛', description: '앱솔루트 프리미엄 분유를 한 달간 사용하고 아이 성장 변화를 블로그에 기록해 주세요', reward: '분유 1개월분 (15만원 상당)', rewardAmount: 150000, headcount: 10, applied: 4, type: 'delivery' },
  { id: 89, brand: '리틀팜', name: '유아 장난감 발달 체험단', channel: '인스타그램', category: '기타', status: '마감임박', applyStart: '2026-07-18', applyEnd: '2026-07-27', announceDate: '2026-07-28', postStart: '2026-07-01', postEnd: '2026-08-21', image: '🎠', description: '리틀팜 발달 장난감 세트로 아이와 함께 놀고 놀이 교육 콘텐츠를 제작해 주세요', reward: '장난감 세트 (10만원 상당)', rewardAmount: 100000, headcount: 15, applied: 14, type: 'delivery' },
  { id: 90, brand: '닥터브로너스', name: '천연 아기 목욕용품 체험', channel: '인스타그램', category: '기타', status: '모집중', applyStart: '2026-07-27', applyEnd: '2026-08-06', announceDate: '2026-08-10', postStart: '2026-08-13', postEnd: '2026-09-13', image: '🛁', description: '닥터브로너스 천연 아기 전용 목욕용품을 사용하고 아이 피부 반응 리뷰를 공유해 주세요', reward: '아기 목욕 세트 (8만원 상당)', rewardAmount: 80000, headcount: 12, applied: 5, type: 'delivery' },
  { id: 91, brand: '롯데리아펫', name: '강아지 간식 체험 리뷰어', channel: '인스타그램', category: '기타', status: '모집중', applyStart: '2026-07-29', applyEnd: '2026-08-08', announceDate: '2026-08-12', postStart: '2026-08-15', postEnd: '2026-09-05', image: '🐶', description: '롯데리아펫 강아지 전용 간식을 체험하고 반려견 반응과 영양 성분을 리뷰해 주세요', reward: '간식 3개월분 (7만원 상당)', rewardAmount: 70000, headcount: 20, applied: 8, type: 'delivery', conditions: ['반려견 1마리 이상 보유', '펫 계정', '팔로워 1,000명 이상'] },
  { id: 92, brand: '퍼피아', name: '강아지 관절 보조제 4주 체험', channel: '블로그', category: '기타', status: '모집중', applyStart: '2026-07-25', applyEnd: '2026-08-04', announceDate: '2026-08-08', postStart: '2026-08-11', postEnd: '2026-09-11', image: '💊', description: '퍼피아 강아지 관절 보조제를 4주 급여하고 관절 개선 변화를 블로그에 상세 기록해 주세요', reward: '관절 보조제 3개월분 (12만원 상당)', rewardAmount: 120000, headcount: 8, applied: 3, type: 'delivery' },
  { id: 93, brand: '캣닙', name: '고양이 프리미엄 사료 체험단', channel: '인스타그램', category: '기타', status: '모집중', applyStart: '2026-07-26', applyEnd: '2026-08-05', announceDate: '2026-08-09', postStart: '2026-08-12', postEnd: '2026-09-02', image: '🐱', description: '캣닙 그레인프리 프리미엄 사료를 4주 급여하고 고양이 털, 체중, 활동량 변화를 공유해 주세요', reward: '사료 3개월분 (10만원 상당)', rewardAmount: 100000, headcount: 15, applied: 6, type: 'delivery' },
  { id: 94, brand: '네이처스레시피', name: '대형견 전용 영양식 체험', channel: '유튜브', category: '기타', status: '모집중', applyStart: '2026-07-28', applyEnd: '2026-08-07', announceDate: '2026-08-11', postStart: '2026-08-14', postEnd: '2026-09-14', image: '🦮', description: '네이처스레시피 대형견 전용 영양식을 4주 급여하고 유튜브 펫 리뷰 영상을 제작해 주세요', reward: '사료 2개월분 + 활동비 5만원', rewardAmount: 50000, headcount: 5, applied: 2, type: 'delivery' },
  { id: 95, brand: '닥터펫', name: '반려동물 종합 영양제 체험', channel: '인스타그램', category: '기타', status: '모집중', applyStart: '2026-07-23', applyEnd: '2026-08-02', announceDate: '2026-08-06', postStart: '2026-07-09', postEnd: '2026-08-29', image: '🐾', description: '닥터펫 반려동물 종합 영양제를 한 달간 급여하고 건강 변화 콘텐츠를 공유해 주세요', reward: '영양제 3개월분 (9만원 상당)', rewardAmount: 90000, headcount: 15, applied: 7, type: 'delivery' },
  { id: 96, brand: '맘스케어', name: '임산부 영양제 체험단', channel: '블로그', category: '기타', status: '마감임박', applyStart: '2026-07-19', applyEnd: '2026-07-25', announceDate: '2026-07-29', postStart: '2026-07-01', postEnd: '2026-07-01', image: '🤰', description: '맘스케어 임산부 전용 영양제를 한 달 복용하고 임신 중 건강관리 체험기를 블로그에 작성해 주세요', reward: '영양제 2개월분 (18만원 상당)', rewardAmount: 180000, headcount: 8, applied: 7, type: 'delivery', conditions: ['임산부 또는 출산 후 12개월 이내', '육아 블로그 운영'] },
  { id: 97, brand: '스마트베어', name: '아이방 스마트 LED 체험', channel: '인스타그램', category: '기타', status: '모집중', applyStart: '2026-07-27', applyEnd: '2026-08-06', announceDate: '2026-08-10', postStart: '2026-08-13', postEnd: '2026-09-13', image: '💡', description: '스마트베어 아이방 LED 조명을 설치하고 아이 수면 환경 개선 콘텐츠를 제작해 주세요', reward: 'LED 조명 세트 (8만원 상당)', rewardAmount: 80000, headcount: 12, applied: 4, type: 'delivery' },
...
export const mockMyCampaigns: MyCampaign[] = [
  ...
  {
    id: 'mc-3', name: '아웃도어 장비 리뷰', brand: '아웃도어킹', channel: '블로그',
...
export const BROWSE_CATEGORIES = ['전체', '뷰티·패션', '맛집·푸드', '생활·리빙', '디지털·가전', '여행·숙박', '기타']
