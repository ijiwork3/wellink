              ...
              <div className="pt-4 mt-2">
                ...
                <div className="space-y-5 text-xs leading-relaxed">
                  {[
                    ...
                    { num: '②', title: '게시 유지 의무', desc: '선정 후 콘텐츠는 최소 90일간 삭제·비공개 전환이 불가합니다. 임의 삭제 시 리워드 회수 및 참여 제한 조치가 취해질 수 있습니다.' },
                    { num: '③', title: '콘텐츠 가이드 준수', desc: '광고주 제공 가이드라인에 따라 제작해야 하며, 허위·과장 표현, 타 브랜드 비교, 부적절한 내용은 금지됩니다.' },
                    { num: '④', title: '리워드 지급', desc: '콘텐츠 검수 완료 후 15영업일 이내 지급됩니다. 활동비는 원천세(3.3%) 공제 후 지급될 수 있습니다.' },
                    { num: '⑤', title: '부정 행위 제재', desc: '팔로워·조회수 조작, 콘텐츠 도용, 중복 신청 등 부정 행위 적발 시 리워드 전액 회수 및 서비스 이용이 제한됩니다.' },
                    { num: '⑥', title: '개인정보 수집·이용', desc: '수집 항목: 이름·연락처·SNS 계정·배송 정보 / 이용 목적: 캠페인 운영·리워드 지급 / 보유 기간: 종료 후 2년' },
