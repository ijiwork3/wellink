...
const STATE_ITEMS: StatusItem[] = [
  ...
  },
  {
    label: '인스타그램 연결',
    children: [
      { label: '연결됨 (기본)', path: '/dashboard?gs=instagram' },
      { label: '미연결', path: '/dashboard?gs=no-instagram' },
    ],
  },
  {
    label: '구독 플랜',
    children: [
      { label: 'Scale 플랜 (기본)', path: '/subscription' },
      { label: 'Focus 플랜', path: '/subscription?qa=plan-focus' },
      { label: 'Infinite 플랜', path: '/subscription?qa=plan-infinite' },
      { label: '무료 체험 중 (D-7)', path: '/subscription?qa=trial' },
      { label: '미구독 (무료)', path: '/subscription?qa=plan-free' },
      { label: '구독 만료', path: '/subscription?qa=expired' },
      { label: '결제 실패', path: '/subscription?qa=payment-failed' },
    ],
  },
  {
    label: '로그인 상태',
    children: [
      { label: '로그인됨 (대시보드)', path: '/dashboard' },
  ...
  },
  {
    label: '글로벌 에러',
    children: [
      { label: '대시보드 에러', path: '/dashboard?qa=error' },
      { label: '캠페인 목록 에러', path: '/campaigns?qa=error' },
      { label: '인플루언서 리스트 에러', path: '/influencers/list?qa=error' },
      { label: '구독 관리 에러', path: '/subscription?qa=error' },
    ],
  },
  {
    label: '글로벌 로딩',
    children: [
      { label: '대시보드 로딩', path: '/dashboard?qa=loading' },
      { label: '캠페인 목록 로딩', path: '/campaigns?qa=loading' },
      { label: '인플루언서 리스트 로딩', path: '/influencers/list?qa=loading' },
      { label: '구독 관리 로딩', path: '/subscription?qa=loading' },
    ],
  },
]
