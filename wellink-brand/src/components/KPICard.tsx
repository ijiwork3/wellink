...
interface KPICardProps {
  ...
  /** 값 텍스트에 적용할 커스텀 색상 클래스 (e.g. 'text-[#8CC63F]') */
  valueColor?: string
  /** hover 시 표시되는 지표 설명 */
  tooltip?: string
}
        ...
        <div className="flex items-center gap-1.5">
          ...
          {tooltip && (
            <div className="relative">
              ...
              {showTooltip && (
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 px-2.5 py-1.5 bg-gray-900 text-white text-[11px] rounded-lg max-w-[200px] text-center z-50 shadow-lg">
                  {tooltip}
