    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => {
            ...
            setTimeout(() => {
              window.location.href = import.meta.env.VITE_BRAND_URL || 'http://localhost:3003'
            }, 800)
          }}
        ...
        <div className="p-6 space-y-8">
          ...
          <section>
            ...
            <div className="border border-gray-200 rounded-xl p-5 flex items-center justify-between">
              ...
              >
                {snsConnected ? 'Instagram 관리' : 'Instagram 연결하기'}
              </button>
            </div>
          </section>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">구독 및 결제 정보를 확인합니다.</p>
            </div>
            <button
          ...
          <div className="bg-[#8CC63F] rounded-2xl p-5 text-white">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-xs text-white/70 mb-1">현재 플랜</div>
                <div className="text-xl font-bold">Scale</div>
                <div className="text-sm text-white/80 mt-1">299,000원/월 · 다음 결제일: 2026-05-01</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-white/70 mb-1">인플루언서 DB</div>
                <div className="text-base font-semibold">50,000명+</div>
              </div>
            </div>
          </div>
          <div className="mt-4 grid grid-cols-2 gap-3">
            {['AI 기반 성과 예측·분석', '우선 인플루언서 매칭', '커스텀 대시보드', '우선 지원'].map(f => (
      ...
      <Modal open={pwModal} onClose={() => setPwModal(false)} title="비밀번호 변경">
        <div className="space-y-4">
          <div>
            <label htmlFor="current-pw" className="text-xs text-gray-500 mb-1.5 block">현재 비밀번호</label>
            <input
              id="current-pw"
              type="password"
              value={currentPw}
          ...
          <div>
            <label htmlFor="new-pw" className="text-xs text-gray-500 mb-1.5 block">새 비밀번호</label>
            <input
              id="new-pw"
              type="password"
              value={newPw}
          ...
          <div>
            <label htmlFor="confirm-pw" className="text-xs text-gray-500 mb-1.5 block">새 비밀번호 확인</label>
            <input
              id="confirm-pw"
              type="password"
              value={confirmPw}
